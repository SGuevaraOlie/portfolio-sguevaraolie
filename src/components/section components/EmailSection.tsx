...
const EmailSection = () => {
    return (
        <section className='grid lg:grid-cols-2 my-12 lg:my-12 py-24 gap-4 space-x-16'>
            <div>
            ...
            <div>
                <form className='flex flex-col gap-6' action="">
                    ...
                    <button type='submit' className='bg-gradient-to-br to-[#ffb826] from-[#96551d] hover:scale-110 lg:text-2xl transition duration-300 ease-in-out text-black px-5 rounded-lg w-full'>Envía el mensaje</button>
                </form>
            </div>
        </section>
    )
