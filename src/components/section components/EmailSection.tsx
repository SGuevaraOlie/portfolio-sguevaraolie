        ...
        <section id='contactForm'>
            <div className='flex flex-col lg:flex-row mb-12 mt-32 lg:mb-48 space-y-12 lg:space-y-0 justify-between'>
                <div className='text-center lg:text-start'>
                    <h5 className='text-2xl lg:text-4xl font-bold text-[#ffb826] mb-4'>¡Contactame!</h5>
                    <p className='text-[#ADB7BE] text-xs lg:text-lg mb-2 max-w-md'>Actualmente estoy buscando nuevas oportunidades para avanzar en mi carrera dentro del campo de la tecnología de la información (IT) y contribuir al crecimiento de una organización. Estoy entusiasmado por explorar roles desafiantes y colaborar en proyectos innovadores que me permitan desarrollar y aplicar mis habilidades.</p>
                    <p className='text-[#ADB7BE] text-xs lg:text-lg mb-2 max-w-md'>¡No dudes en escribirme, y me pondré en contacto cuanto antes!</p>
                ...
                <div>
                    <form className='flex flex-col w-full lg:w-[600px] space-y-6 lg:space-y-12' onSubmit={handleSubmit}>
                        <div className='flex flex-col'>
                            <label htmlFor="email" className='text-white block mb-2 text-xs lg:text-lg font-medium'>Tu Email:</label>
                        ...
                        <div className='flex flex-col'>
                            <label htmlFor="subject" className='text-white block mb-2 text-xs lg:text-lg font-medium'>Asunto:</label>
                        ...
                        <div className='flex flex-col'>
                            <label htmlFor="message" className='text-white block mb-2 text-xs lg:text-lg font-medium'>Cuerpo del mail:</label>
