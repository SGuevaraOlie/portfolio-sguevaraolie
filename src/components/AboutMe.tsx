...
const TAB_DATA = [
    ...
    },
    {
        ...
        id: 'Educación',
        content:(
            <div className='flex flex-row justify-around mt-2 text-xs lg:text-base'>
                <div>
                    <h1>SoyHenry</h1>
                ...
                <div>
                    <h1>Arrow Academy</h1>
                    <p>Introducción a Phyton / POO / DJANGO</p>
                </div>
            </div>
        )
    },
...
const AboutMe = () => {
    ...
    return (
        <section className='text-white'>
            <div className='flex flex-col lg:flex-row justify-center items-center mt-56 mb-32 lg:mt-72 lg:mb-48'>
