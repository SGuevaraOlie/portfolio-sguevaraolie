        ...
        <section>
            <div className="flex flex-col mb-2 min-h-[600px]">
                <div className="flex flex-col lg:flex-row justify-center items-center mt-8">
                    ...
                    <div className="place-self-center lg:mt-8 mt-6 mb-6 lg:mb-0">
                ...
                <div className="flex flex-row lg:mt-24 justify-center">
                    <button className="px-6 py-3 w-full sm:w-fit rounded-full font-semibold bg-gradient-to-br to-[#ffb826] from-[#96551d] hover:scale-110 lg:text-2xl transition duration-300 ease-in-out text-black mr-4 lg:mr-24">Contactame</button>
                    <button className="px-6 py-3 w-full sm:w-fit rounded-full font-semibold bg-gradient-to-br to-[#ffb826] from-[#96551d] hover:scale-110 lg:text-2xl transition duration-300 ease-in-out text-black">Descarga mi CV</button>
                </div>
            </div>
        </section>
    )
